  ...
  <div class="container">
    <div class="row">
      <div class="col-12 col-md-10 col-lg-8">
        ...
        <h2 class="display-5 mb-4 mb-md-5 mb-xl-8">Our team is very concerned <br>about your experience.</h2>
      </div>
    </div>
  </div>
  <div class="container">
          ...
          <div class="col-12 col-xl-11">
            <div class="mb-4 mb-md-5">
              ...
              <div>
                ...
                <address class="m-0 text-secondary">IFBA Campus Seabra</address>
              </div>
            </div>
